...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Modal button event listeners    cancelEditProductBtn.addEventListener('click', function() {
    ...
    // Form submission handlers    editProductForm.addEventListener('submit', function(e) {
        e.preventDefault();
        updateProduct();
    });
    ...
    // Function stub for global access
    function deleteProduct() {
        window.deleteProductImplementation();
    }
...
/**
 * Global implementation of delete product functionality
 * This function is called by the stub within the DOMContentLoaded scope
 */
window.deleteProductImplementation = function() {
    ...
    .then(response => {
        if (response.ok) {
            ...
            if (toast && toastMessage && toastIcon) {
                toastMessage.textContent = 'Product deleted successfully!';
                toast.className = 'toast toast-success';
                toastIcon.innerHTML = '<i class="fas fa-check-circle"></i>';
    ...
    .catch(error => {
        ...
        if (toast && toastMessage && toastIcon) {
            toastMessage.textContent = 'Error deleting product. Please try again.';
            toast.className = 'toast toast-error';
            toastIcon.innerHTML = '<i class="fas fa-exclamation-circle"></i>';
            toast.classList.add('visible');
